...
API key, no OAuth, and no registration.

Copied and adapted from the original TradingAgents stocktwits.py.
"""
...
def fetch_stocktwits_messages(
    ...
    symbol has no messages, or the response shape is unexpected.
    """
